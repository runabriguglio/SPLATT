...
def acc_trig(wdflist, f_thr = 200):
    ...
    for k,wdf in enumerate(wdflist):
        ...
        sig_len = np.arange(-100,1200,dtype=int)
        ...
        acc_len = np.arange(-10,500,dtype=int)
...
# Gap1, Vac2
wdflist12 = ['OBB-Vibration_2025-02-18T17-03-39-102.wdd',
...
sig12, f_sig, acc12, f_acc = acc_trig(wdflist12)

# Gap2, Vac2
wdflist22 = ['OBB-Vibration_2025-02-18T17-09-26-405.wdd',
...
sig22, f_sig, acc22, f_acc = acc_trig(wdflist22)

# Gap3, Vac2
wdflist32 = ['OBB-Vibration_2025-02-18T17-15-13-463.wdd',
...
sig32, f_sig, acc32, f_acc = acc_trig(wdflist32)



# Gap1, Vac1
wdflist11 = ['OBB-Vibration_2025-02-19T16-44-25-595.wdd',
...
sig11, f_sig, acc11, f_acc = acc_trig(wdflist11)

# Gap2, Vac1
wdflist21 = ['OBB-Vibration_2025-02-19T16-50-03-197.wdd',
...
sig21, f_sig, acc21, f_acc = acc_trig(wdflist21)

# Gap3, Vac1
wdflist31 = ['OBB-Vibration_2025-02-19T16-55-39-260.wdd',
...
sig31, f_sig, acc31, f_acc = acc_trig(wdflist31)




# Gap1, Vac0
wdflist10 = ['OBB-Vibration_2025-02-19T17-12-30-930.wdd',
...
sig10, f_sig, acc10, f_acc = acc_trig(wdflist10)

# Gap2, Vac0
wdflist20 = ['OBB-Vibration_2025-02-19T17-18-09-177.wdd',
...
sig20, f_sig, acc20, f_acc = acc_trig(wdflist20)

# Gap3, Vac0
wdflist30 = ['OBB-Vibration_2025-02-19T17-23-44-112.wdd',
...
sig30, f_sig, acc30, f_acc = acc_trig(wdflist30)